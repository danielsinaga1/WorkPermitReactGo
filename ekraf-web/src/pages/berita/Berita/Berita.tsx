...
import { CardBerita } from "../../../components/beritacomponents/CardBerita";
...
const Berita: React.FC = () => {
  ...
  const allData = newsData as NewsItem[];
  ...
  return (
    <div className="pp-page-content" style={{ minHeight: "100vh", background: "#f8fafc" }}>
      <PageHeroBanner
        title="Berita"
        subtitle="Seputar Informasi Berita Kemenekraf / Bekraf Republik Indonesia"
        icon="pi pi-megaphone"
        tag="BERITA"
        breadcrumbItems={[{ label: "Beranda", url: "/" }, { label: "Berita" }]}
      />
      ...
      <div className="bp-content-section">
        ...
        {currentData.length > 0 ? (
          ...
          <div className="bp-empty-state">
            ...
            <p style={{ color: "#6b7280", fontSize: "0.95rem" }}>Belum ada berita tersedia.</p>
          </div>
        )}
