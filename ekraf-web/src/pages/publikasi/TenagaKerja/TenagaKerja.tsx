...
import { CardTenagaKerja } from "../../../components/publikasicomponents/tenagakerjacomponents/CardTenagaKerja";
...
const TenagaKerja: React.FC = () => {
  const [first, setFirst] = useState(0);
  const [searchQuery, setSearchQuery] = useState("");

  const allData = tenagakerjadata as unknown as TenagaKerjaItem[];
  ...
  return (
    <div className="pp-page-content" style={{ minHeight: "100vh", background: "#f8fafc" }}>
      <PageHeroBanner
        title="Tenaga Kerja"
        subtitle="Seputar Informasi Tenaga Kerja Dinas DISPOPAR Bontang"
        icon="pi pi-users"
        tag="PUBLIKASI"
        breadcrumbItems={[{ label: "Beranda", url: "/" }, { label: "Publikasi" }, { label: "Tenaga Kerja" }]}
      />
