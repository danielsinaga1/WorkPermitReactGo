...
export const Modal = ({ closeModal, onSubmit, defaultValue }: ModalProps) => {
  ...
  const handleChange = (e: React.ChangeEvent<HTMLInputElement | HTMLSelectElement>) => {
    ...
    console.log(parseInt(formState.criterion)>1&&parseInt(formState.criterion)<4);
    console.log(e.target.value);
    console.log(e.target.name=="para"&&e.target.value=='rating'&&parseInt(formState.criterion)>1&&parseInt(formState.criterion)<4);
