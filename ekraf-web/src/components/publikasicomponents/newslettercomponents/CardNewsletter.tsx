...
export const CardNewsletter = ({ id, title, content, date, image }: CardNewsletterProps) => {
  return (
    <div className="bp-article-card">
      ...
      <div className="article-body">
        ...
        <div className="article-footer">
          <Tag value="Newsletter" style={{ fontSize: '0.7rem', background: '#8b5cf6', color: '#fff' }} />
          <Link to={`/publisher/newsletter/${String(id)}`}>
