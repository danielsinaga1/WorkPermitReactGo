...
export const CardTenagaKerja = ({ id, title, content, date, image }: CardTenagaKerjaProps) => {
  return (
    <div className="bp-article-card">
      ...
      <div className="article-body">
        ...
        <div className="article-footer">
          <Tag value="Tenaga Kerja" style={{ fontSize: '0.7rem', background: '#f97316', color: '#fff' }} />
          <Link to={`/publisher/tenaga-kerja/${String(id)}`}>
